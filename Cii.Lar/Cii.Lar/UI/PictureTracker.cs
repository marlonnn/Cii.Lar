...
namespace Cii.Lar.UI
{
    ...
    /// </summary>
    public partial class PictureTracker : UserControl
    {
        /// <summary>
        ...
        /// </summary>
        private Font zoomRateFont = new System.Drawing.Font("Times New Roman", 9.75F, ((System.Drawing.FontStyle)((System.Drawing.FontStyle.Bold | System.Drawing.FontStyle.Italic))), System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        ...
        public PictureTracker()
        {
            ...
            this.trackerCursor = Cursors.SizeAll;
        }
        ...
        public Image Picture
        {
            set
            {
                ...
                if (value != null)
                {
                    ...
                    this.thumbnail = Util.CreateThumbnail(value, srcRect.Height);

                    this.pictureDestRect = Util.ScaleToFit(this.thumbnail, srcRect, false);
        ...
        public void OnPictureBoxPainted(Rectangle showingRect, Rectangle pictureBoxRect)
        {
            ...
            if (this.highlightingRect.IsEmpty)
            {
                //After start or picture change redraw the entire thumbnail.
                regionToInvalidate = new Region(this.picturePanel.ClientRectangle);
            }
            else
            {
                // Redraw the thumbnail part covered till now.
                regionToInvalidate = new Region(this.highlightingRect);
            }
            ...
            highlightingRect = new Rectangle(
                (int)(this.pictureDestRect.X + this.pictureDestRect.Width * xPosScale),
        ...
        private void CloseButton_Click(object sender, EventArgs e)
        {
            ...
            if (this.PictureTrackerClosed != null)
            {
        ...
        private void PicturePanel_MouseDown(object sender, MouseEventArgs e)
        {
            if (this.highlightingRect.Contains(e.X, e.Y))
            {
                ...
                this.lastMousePosOfDragging = new Point(e.X, e.Y);
            }
        }
        ...
        {
            if (this.ScrollPictureEvent != null && this.isDragging && 
                (this.lastMousePosOfDragging.X != e.X || this.lastMousePosOfDragging.Y != e.Y))
            {
